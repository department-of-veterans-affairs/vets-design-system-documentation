...
I want you to fully solve this autonomously before coming back to me. Before you answer or solve the problem, assess the uncertainty of your response. If it's greater than 0.1, ask me clarifying questions until the uncertainty is 0.1 or lower.

Once uncertainty is 0.1 or lower, only terminate your turn when you are sure that the problem is solved and all items have been checked off. Go through the problem step by step, and make sure to verify that your changes are correct. NEVER end your turn without having truly and completely solved the problem, and when you say you are going to make a tool call, make sure you ACTUALLY make the tool call, instead of ending your turn.
...
- Specifics on how to manage issues are in [github-issue-commands.md](../github-issue-commands.md) including repository context, key GitHub CLI commands for viewing, creating, and managing issues, issue templates and when to use them, component specific workflows, common issue management workflows, and best practices.
...
- Use the [PULL_REQUEST_TEMPLATE.md](../PULL_REQUEST_TEMPLATE.md) template when creating a pull request.
- Read and fill out the template carefully.
