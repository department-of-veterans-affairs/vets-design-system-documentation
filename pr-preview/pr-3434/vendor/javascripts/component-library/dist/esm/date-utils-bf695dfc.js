...
function validate({ component, year, month, day, monthYearOnly, yearTouched, monthTouched, dayTouched, monthSelect }) {
...
function getErrorParameters(error, year, month) {
...
const daysForSelectedMonth = (year, month) => year && month ? new Date(year, month, 0).getDate() : 31;
/**
 ...
 */
const zeroPadStart = (number) => `00${(number || '').toString()}`.slice(-2);
/* eslint-enable i18next/no-literal-string */

export { isDateBefore as a, isDateAfter as b, days as d, formatDate as f, getErrorParameters as g, isDateSameDay as i, months as m, validate as v, zeroPadStart as z };
