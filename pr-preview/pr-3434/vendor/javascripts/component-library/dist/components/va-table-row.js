...
const VaTableRow$1 = /*@__PURE__*/ proxyCustomElement(class VaTableRow extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return VaTableRowStyle0; }
}, [1, "va-table-row"]);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["va-table-row"];
    components.forEach(tagName => { switch (tagName) {
        case "va-table-row":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, VaTableRow$1);
            }
            break;
    } });
}

const VaTableRow = VaTableRow$1;
const defineCustomElement = defineCustomElement$1;

export { VaTableRow, defineCustomElement };
