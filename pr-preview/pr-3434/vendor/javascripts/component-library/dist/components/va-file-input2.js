...
import './contacts.js';
import { s as selectOrMatches, S as Sanitizer } from './utils.js';
import { d as defineCustomElement$5 } from './va-button2.js';
import { d as defineCustomElement$4 } from './va-button-icon2.js';
import { d as defineCustomElement$3 } from './va-card2.js';
import { d as defineCustomElement$2 } from './va-icon2.js';
import { d as defineCustomElement$1 } from './va-modal2.js';
...
const VaFileInput = /*@__PURE__*/ proxyCustomElement(class VaFileInput extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
        ...
        this.renderLabelOrHeader = (label, required, headerSize) => {
            const requiredSpan = required ? (h("span", { class: "required" }, " ", instance.t('required'))) : null;
...
function defineCustomElement() {
    ...
    const components = ["va-file-input", "va-button", "va-button-icon", "va-card", "va-icon", "va-modal"];
    components.forEach(tagName => { switch (tagName) {
        case "va-file-input":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, VaFileInput);
            }
            break;
        case "va-button":
            if (!customElements.get(tagName)) {
...
export { VaFileInput as V, defineCustomElement as d };
