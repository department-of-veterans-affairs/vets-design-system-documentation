...
const VaCheckboxGroup$1 = /*@__PURE__*/ proxyCustomElement(class VaCheckboxGroup extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    }, [[0, "vaChange", "vaChangeHandler"]]]);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["va-checkbox-group"];
    components.forEach(tagName => { switch (tagName) {
        case "va-checkbox-group":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, VaCheckboxGroup$1);
            }
            break;
    } });
}

const VaCheckboxGroup = VaCheckboxGroup$1;
const defineCustomElement = defineCustomElement$1;

export { VaCheckboxGroup, defineCustomElement };
