...
const VaAlert = /*@__PURE__*/ proxyCustomElement(class VaAlert extends HTMLElement {
    ...
    get el() { return this; }
    static get style() { return VaAlertStyle0; }
}, [1, "va-alert", {
        "status": [513],
...
function defineCustomElement() {
    ...
    const components = ["va-alert", "va-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "va-alert":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, VaAlert);
            }
            break;
        case "va-icon":
            if (!customElements.get(tagName)) {
...
export { VaAlert as V, defineCustomElement as d };
