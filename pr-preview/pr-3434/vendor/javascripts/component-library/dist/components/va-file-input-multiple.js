...
import { d as defineCustomElement$6 } from './va-button-icon2.js';
import { d as defineCustomElement$5 } from './va-card2.js';
import { d as defineCustomElement$4 } from './va-file-input2.js';
...
const VaFileInputMultiple$1 = /*@__PURE__*/ proxyCustomElement(class VaFileInputMultiple extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
        this.vaMultipleChange = createEvent(this, "vaMultipleChange", 7);
        /**
    ...
    get el() { return this; }
    static get style() { return VaFileInputMultipleStyle0; }
}, [1, "va-file-input-multiple", {
        "label": [1],
        "name": [1],
        "required": [4],
        "accept": [1],
...
function defineCustomElement$1() {
    ...
    const components = ["va-file-input-multiple", "va-button", "va-button-icon", "va-card", "va-file-input", "va-icon", "va-modal"];
    components.forEach(tagName => { switch (tagName) {
        case "va-file-input-multiple":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, VaFileInputMultiple$1);
            }
            break;
        case "va-button":
            if (!customElements.get(tagName)) {
...
const VaFileInputMultiple = VaFileInputMultiple$1;
const defineCustomElement = defineCustomElement$1;

export { VaFileInputMultiple, defineCustomElement };
