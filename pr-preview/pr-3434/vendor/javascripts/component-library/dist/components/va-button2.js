...
const VaButton = /*@__PURE__*/ proxyCustomElement(class VaButton extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    get el() { return this; }
    static get style() { return VaButtonStyle0; }
}, [1, "va-button", {
        "back": [516],
        "big": [516],
        "continue": [516],
        ...
        "disabled": [516],
        "label": [1],
        "primaryAlternate": [4, "primary-alternate"],
        "secondary": [516],
        "submit": [1],
        "text": [1],
        "messageAriaDescribedby": [1, "message-aria-describedby"]
    }, [[0, "click", "handleClickOverride"]]]);
function defineCustomElement() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["va-button", "va-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "va-button":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, VaButton);
            }
            break;
        case "va-icon":
            if (!customElements.get(tagName)) {
...
export { VaButton as V, defineCustomElement as d };
