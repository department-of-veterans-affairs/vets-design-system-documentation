...
const VaAdditionalInfo$1 = /*@__PURE__*/ proxyCustomElement(class VaAdditionalInfo extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    get el() { return this; }
    static get style() { return VaAdditionalInfoStyle0; }
}, [1, "va-additional-info", {
        "trigger": [1],
        "disableAnalytics": [4, "disable-analytics"],
        "disableBorder": [4, "disable-border"],
        "open": [32]
...
function defineCustomElement$1() {
    ...
    const components = ["va-additional-info", "va-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "va-additional-info":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, VaAdditionalInfo$1);
            }
            break;
        case "va-icon":
            if (!customElements.get(tagName)) {
...
const VaAdditionalInfo = VaAdditionalInfo$1;
const defineCustomElement = defineCustomElement$1;

export { VaAdditionalInfo, defineCustomElement };
