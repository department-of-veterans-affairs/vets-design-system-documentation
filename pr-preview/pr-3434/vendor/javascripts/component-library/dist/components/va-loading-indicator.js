...
const VaLoadingIndicator$1 = /*@__PURE__*/ proxyCustomElement(class VaLoadingIndicator extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    get el() { return this; }
    static get style() { return VaLoadingIndicatorStyle0; }
}, [1, "va-loading-indicator", {
        "message": [1],
        "label": [1],
        "setFocus": [4, "set-focus"],
...
function defineCustomElement$1() {
    ...
    const components = ["va-loading-indicator"];
    components.forEach(tagName => { switch (tagName) {
        case "va-loading-indicator":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, VaLoadingIndicator$1);
            }
            break;
    } });
}

const VaLoadingIndicator = VaLoadingIndicator$1;
const defineCustomElement = defineCustomElement$1;

export { VaLoadingIndicator, defineCustomElement };
