...
const VaRadioOption$1 = /*@__PURE__*/ proxyCustomElement(class VaRadioOption extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    get el() { return this; }
    static get style() { return VaRadioOptionStyle0; }
}, [0, "va-radio-option", {
        "name": [1],
        "label": [1],
        "value": [1],
...
function defineCustomElement$1() {
    ...
    const components = ["va-radio-option"];
    components.forEach(tagName => { switch (tagName) {
        case "va-radio-option":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, VaRadioOption$1);
            }
            break;
    } });
}

const VaRadioOption = VaRadioOption$1;
const defineCustomElement = defineCustomElement$1;

export { VaRadioOption, defineCustomElement };
