...
const VaPromoBanner$1 = /*@__PURE__*/ proxyCustomElement(class VaPromoBanner extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    get el() { return this; }
    static get style() { return VaPromoBannerStyle0; }
}, [1, "va-promo-banner", {
        "href": [1],
        "type": [1],
...
function defineCustomElement$1() {
    ...
    const components = ["va-promo-banner", "va-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "va-promo-banner":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, VaPromoBanner$1);
            }
            break;
        case "va-icon":
            if (!customElements.get(tagName)) {
...
const VaPromoBanner = VaPromoBanner$1;
const defineCustomElement = defineCustomElement$1;

export { VaPromoBanner, defineCustomElement };
