...
import { d as defineCustomElement$3 } from './va-checkbox2.js';
...
const VaPrivacyAgreement$1 = /*@__PURE__*/ proxyCustomElement(class VaPrivacyAgreement extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return VaPrivacyAgreementStyle0; }
}, [1, "va-privacy-agreement", {
        "checked": [1028],
...
function defineCustomElement$1() {
    ...
    const components = ["va-privacy-agreement", "va-checkbox", "va-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "va-privacy-agreement":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, VaPrivacyAgreement$1);
            }
            break;
        case "va-checkbox":
            if (!customElements.get(tagName)) {
...
const VaPrivacyAgreement = VaPrivacyAgreement$1;
const defineCustomElement = defineCustomElement$1;

export { VaPrivacyAgreement, defineCustomElement };
