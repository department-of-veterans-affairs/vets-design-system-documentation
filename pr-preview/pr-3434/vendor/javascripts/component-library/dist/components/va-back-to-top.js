...
const VaBackToTop$1 = /*@__PURE__*/ proxyCustomElement(class VaBackToTop extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    get el() { return this; }
    static get style() { return VaBackToTopStyle0; }
}, [1, "va-back-to-top", {
        "revealed": [32],
        "isDocked": [32]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["va-back-to-top", "va-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "va-back-to-top":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, VaBackToTop$1);
            }
            break;
        case "va-icon":
            if (!customElements.get(tagName)) {
...
const VaBackToTop = VaBackToTop$1;
const defineCustomElement = defineCustomElement$1;

export { VaBackToTop, defineCustomElement };
