...
const VaSearchInput$1 = /*@__PURE__*/ proxyCustomElement(class VaSearchInput extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return VaSearchInputStyle0; }
}, [1, "va-search-input", {
...
function defineCustomElement$1() {
    ...
    const components = ["va-search-input", "va-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "va-search-input":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, VaSearchInput$1);
            }
            break;
        case "va-icon":
            if (!customElements.get(tagName)) {
...
const VaSearchInput = VaSearchInput$1;
const defineCustomElement = defineCustomElement$1;

export { VaSearchInput, defineCustomElement };
