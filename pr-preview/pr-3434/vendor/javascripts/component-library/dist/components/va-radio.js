...
import { g as getSlottedNodes, a as getHeaderLevel } from './utils.js';
...
const VaRadio$1 = /*@__PURE__*/ proxyCustomElement(class VaRadio extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    get el() { return this; }
    static get style() { return VaRadioStyle0; }
}, [1, "va-radio", {
        "label": [1],
        "hint": [1],
        "required": [4],
    ...
    }, [[0, "keydown", "handleKeyDown"], [0, "radioOptionSelected", "radioOptionSelectedHandler"]]]);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["va-radio"];
    components.forEach(tagName => { switch (tagName) {
        case "va-radio":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, VaRadio$1);
            }
            break;
    } });
}

const VaRadio = VaRadio$1;
const defineCustomElement = defineCustomElement$1;

export { VaRadio, defineCustomElement };
