...
import { d as defineCustomElement$2 } from './va-button2.js';
...
const VaModal = /*@__PURE__*/ proxyCustomElement(class VaModal extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return VaModalStyle0; }
}, [1, "va-modal", {
        "clickToClose": [4, "click-to-close"],
        "disableAnalytics": [4, "disable-analytics"],
        "large": [516],
        "modalTitle": [1, "modal-title"],
        "forcedModal": [4, "forced-modal"],
        "unstyled": [4],
        "initialFocusSelector": [1, "initial-focus-selector"],
        "primaryButtonText": [1, "primary-button-text"],
        "secondaryButtonText": [1, "secondary-button-text"],
        "status": [1],
        "visible": [516],
        "ariaHiddenNodeExceptions": [16],
        "shifted": [32]
    }, [[0, "component-library-analytics", "handleButtonClickAnalytics"], [0, "click", "handleClick"], [8, "keydown", "handleKeyDown"]], {
        "visible": ["watchVisibleHandler"]
    }]);
function defineCustomElement() {
    ...
    const components = ["va-modal", "va-button", "va-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "va-modal":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, VaModal);
            }
            break;
        case "va-button":
            if (!customElements.get(tagName)) {
...
export { VaModal as V, defineCustomElement as d };
