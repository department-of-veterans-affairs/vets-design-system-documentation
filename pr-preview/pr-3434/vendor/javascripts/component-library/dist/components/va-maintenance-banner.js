...
import { i as isDateSameDay, f as formatDate, a as isDateBefore, b as isDateAfter } from './date-utils.js';
...
const VaMaintenanceBanner$1 = /*@__PURE__*/ proxyCustomElement(class VaMaintenanceBanner extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return VaMaintenanceBannerStyle0; }
}, [1, "va-maintenance-banner", {
        "disableAnalytics": [4, "disable-analytics"],
        "bannerId": [1, "banner-id"],
        "maintenanceStartDateTime": [1, "maintenance-start-date-time"],
        "maintenanceEndDateTime": [1, "maintenance-end-date-time"],
        "maintenanceTitle": [1, "maintenance-title"],
        "upcomingWarnStartDateTime": [1, "upcoming-warn-start-date-time"],
        "upcomingWarnTitle": [1, "upcoming-warn-title"],
        "isError": [4, "is-error"]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["va-maintenance-banner", "va-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "va-maintenance-banner":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, VaMaintenanceBanner$1);
            }
            break;
        case "va-icon":
            if (!customElements.get(tagName)) {
...
const VaMaintenanceBanner = VaMaintenanceBanner$1;
const defineCustomElement = defineCustomElement$1;

export { VaMaintenanceBanner, defineCustomElement };
