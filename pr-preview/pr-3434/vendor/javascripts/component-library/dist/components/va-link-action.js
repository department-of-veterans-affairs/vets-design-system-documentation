...
const VaLinkAction$1 = /*@__PURE__*/ proxyCustomElement(class VaLinkAction extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return VaLinkActionStyle0; }
}, [1, "va-link-action", {
...
function defineCustomElement$1() {
    ...
    const components = ["va-link-action", "va-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "va-link-action":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, VaLinkAction$1);
            }
            break;
        case "va-icon":
            if (!customElements.get(tagName)) {
...
const VaLinkAction = VaLinkAction$1;
const defineCustomElement = defineCustomElement$1;

export { VaLinkAction, defineCustomElement };
