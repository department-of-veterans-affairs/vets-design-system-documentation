...
const VaProcessListItem$1 = /*@__PURE__*/ proxyCustomElement(class VaProcessListItem extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return VaProcessListItemStyle0; }
}, [4, "va-process-list-item", {
        "header": [1],
        "level": [2],
        "active": [4],
        "pending": [4],
...
function defineCustomElement$1() {
    ...
    const components = ["va-process-list-item"];
    components.forEach(tagName => { switch (tagName) {
        case "va-process-list-item":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, VaProcessListItem$1);
            }
            break;
    } });
}

const VaProcessListItem = VaProcessListItem$1;
const defineCustomElement = defineCustomElement$1;

export { VaProcessListItem, defineCustomElement };
