...
const VaBreadcrumbs$1 = /*@__PURE__*/ proxyCustomElement(class VaBreadcrumbs extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return VaBreadcrumbsStyle0; }
}, [1, "va-breadcrumbs", {
        "label": [1],
        "wrapping": [4],
        "breadcrumbList": [1, "breadcrumb-list"],
        "homeVeteransAffairs": [4, "home-veterans-affairs"],
        "disableAnalytics": [4, "disable-analytics"],
        "formattedBreadcrumbs": [32]
    }, undefined, {
        "breadcrumbList": ["watchBreadcrumbListHandler"]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["va-breadcrumbs"];
    components.forEach(tagName => { switch (tagName) {
        case "va-breadcrumbs":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, VaBreadcrumbs$1);
            }
            break;
    } });
}

const VaBreadcrumbs = VaBreadcrumbs$1;
const defineCustomElement = defineCustomElement$1;

export { VaBreadcrumbs, defineCustomElement };
