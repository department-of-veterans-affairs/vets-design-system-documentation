...
import { d as defineCustomElement$3 } from './va-button2.js';
...
const VaButtonPair$1 = /*@__PURE__*/ proxyCustomElement(class VaButtonPair extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return VaButtonPairStyle0; }
}, [1, "va-button-pair", {
        "continue": [4],
        ...
        "submit": [1],
        "update": [4],
        "leftButtonText": [1, "left-button-text"],
        "rightButtonText": [1, "right-button-text"]
    }, [[0, "component-library-analytics", "handleButtonAnalytics"]]]);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["va-button-pair", "va-button", "va-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "va-button-pair":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, VaButtonPair$1);
            }
            break;
        case "va-button":
            if (!customElements.get(tagName)) {
...
const VaButtonPair = VaButtonPair$1;
const defineCustomElement = defineCustomElement$1;

export { VaButtonPair, defineCustomElement };
