...
const VaTextarea$1 = /*@__PURE__*/ proxyCustomElement(class VaTextarea extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return VaTextareaStyle0; }
        ...
        "labelHeaderLevel": [1, "label-header-level"],
        "headerAriaDescribedby": [1, "header-aria-describedby"],
...
function defineCustomElement$1() {
    ...
    const components = ["va-textarea"];
    components.forEach(tagName => { switch (tagName) {
        case "va-textarea":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, VaTextarea$1);
            }
            break;
    } });
}

const VaTextarea = VaTextarea$1;
const defineCustomElement = defineCustomElement$1;

export { VaTextarea, defineCustomElement };
