...
import { v as validate, z as zeroPadStart, g as getErrorParameters, m as months } from './date-utils.js';
import { a as getHeaderLevel } from './utils.js';
...
const VaMemorableDate$1 = /*@__PURE__*/ proxyCustomElement(class VaMemorableDate extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    render() {
        ...
        const describedbyIds = ['dateHint', hint ? 'hint' : '']
            .filter(Boolean)
            .join(' ');
        const hintText = monthSelect ? instance.t('date-hint-with-select') : instance.t('date-hint');
        ...
        const getStandardErrorMessage = (error) => {
            return instance.t(error, errorParameters(error));
        };
        ...
        return (h(Host, { onBlur: handleDateBlur }, formsHeading, h("div", { class: "input-wrap" }, h("fieldset", { class: "usa-form usa-fieldset" }, h("legend", { class: legendClass, id: "input-label", part: "legend" }, label, required && h("span", { class: "usa-label--required" }, " ", instance.t('required')), hint && h("div", { class: "usa-hint", id: "hint" }, hint), h("span", { class: "usa-hint", id: "dateHint" }, hintText)), h("span", { id: "error-message", role: "alert" }, error && (h(Fragment, null, h("span", { class: "usa-sr-only" }, instance.t('error')), h("span", { class: "usa-error-message" }, getErrorMessage(error))))), h("slot", null), h("div", { class: "usa-memorable-date" }, monthDisplay, h("div", { class: "usa-form-group usa-form-group--day" }, h("va-text-input", { label: instance.t('day'), name: name ? `${name}Day` : 'Day', maxlength: 2, pattern: "[0-9]*", "aria-describedby": describedbyIds, invalid: this.invalidDay,
            // Value must be a string
            // if NaN provide empty string
    ...
    get el() { return this; }
    static get style() { return VaMemorableDateStyle0; }
}, [1, "va-memorable-date", {
        "required": [4],
        "useFormsPattern": [1, "use-forms-pattern"],
        "formHeadingLevel": [2, "form-heading-level"],
        "formHeading": [1, "form-heading"],
        "monthSelect": [4, "month-select"],
        "label": [1],
        "name": [1],
        "hint": [1],
        "error": [1537],
        "value": [1537],
        "customDayErrorMessage": [1, "custom-day-error-message"],
        "customMonthErrorMessage": [1, "custom-month-error-message"],
        "customYearErrorMessage": [1, "custom-year-error-message"],
...
function defineCustomElement$1() {
    ...
    const components = ["va-memorable-date", "va-icon", "va-select", "va-text-input"];
    components.forEach(tagName => { switch (tagName) {
        case "va-memorable-date":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, VaMemorableDate$1);
            }
            break;
        case "va-icon":
            if (!customElements.get(tagName)) {
...
const VaMemorableDate = VaMemorableDate$1;
const defineCustomElement = defineCustomElement$1;

export { VaMemorableDate, defineCustomElement };
