...
const VaBreadcrumbs = class {
    constructor(hostRef) {
        ...
        this.routeChange = index.createEvent(this, "routeChange", 7);
    ...
    render() {
        ...
        const wrapClass = index$1.classnames({
            'usa-breadcrumb': true,
            'usa-breadcrumb--wrap': wrapping,
        });
        return (index.h(index.Host, { key: 'bad1db01e0e41c1d062ce8cca9d2220ee64e2d17' }, index.h("nav", { key: 'fc74e436bb6dd64c42d5ceb7ec3a96aa795e5386', "aria-label": label, class: wrapClass }, index.h("ol", { key: '8cd9dfc7661b88a305794d0b843a8c7844549998', role: "list", class: "usa-breadcrumb__list" }, this.formattedBreadcrumbs.map((item, index$1) => (index.h("li", { class: `usa-breadcrumb__list-item ${index$1 === this.formattedBreadcrumbs.length - 1
                ? 'usa-current'
                : ''}`, "aria-current": index$1 === this.formattedBreadcrumbs.length - 1
                ? 'page'
                : undefined }, index$1 === this.formattedBreadcrumbs.length - 1 ? (index.h("a", { class: "usa-breadcrumb__link", href: "#content", onClick: e => this.fireAnalyticsEvent(e), lang: item.lang || 'en-US', hreflang: item.lang || 'en-US' }, index.h("span", null, item.label))) : (index.h("a", { class: "usa-breadcrumb__link", href: item.href, onClick: e => this.handleClick(e, item), lang: item.lang || 'en-US', hreflang: item.lang || 'en-US' }, index.h("span", null, item.label))))))))));
    }
...
exports.va_breadcrumbs = VaBreadcrumbs;
