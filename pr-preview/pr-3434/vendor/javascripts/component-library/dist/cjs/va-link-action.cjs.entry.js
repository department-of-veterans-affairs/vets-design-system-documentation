...
const VaLinkAction = class {
    ...
    render() {
        ...
        const iconClass = index$1.classnames('link-icon--left', 'link-icon', {
            'link-icon--reverse': type === 'reverse',
        });
        const ariaDescribedbyIds = messageAriaDescribedby
            ? 'link-description'
            : null;
        return (index.h(index.Host, { key: 'eb517903e355dac7615651174417dac4b401b8f5' }, index.h("a", { key: 'eb7780b0ce6712102ce401cc778e193811614962', href: href, class: linkClass, "aria-label": label, "aria-describedby": ariaDescribedbyIds, onClick: handleClick, ref: el => (this.linkRef = el) }, index.h("va-icon", { key: '5d23a38a3c9e7e9af5e1022a26c490507499282d', class: iconClass, icon: "chevron_right", size: 3 }), index.h("span", { key: 'ba6e5703344849b7bd469b59140ca9e323be3191', class: "link-text" }, text)), messageAriaDescribedby && (index.h("span", { key: '63e028a4a35003ea50f4de60cbf98d752c5e0327', id: "link-description", class: "sr-only" }, messageAriaDescribedby))));
    }
...
exports.va_link_action = VaLinkAction;
