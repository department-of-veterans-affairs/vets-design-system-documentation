...
const VaAdditionalInfo = class {
    ...
    render() {
        const infoClass = index$1.classnames({
            'open': this.open,
            'closed': !this.open
        });
        return (index.h(index.Host, { key: '7ecc3bd7445b911ef0e130dfd6ae48f911e707d0' }, index.h("a", { key: '651409ca62ed7ab5c3c7125d520c7d0004e377e0', role: "button", "aria-controls": "info", "aria-expanded": this.open ? 'true' : 'false', tabIndex: 0, onClick: this.toggleOpen.bind(this), onKeyDown: this.handleKeydown.bind(this) }, index.h("div", { key: '151a2e757ff3042df48516ee7501916c811d757c' }, index.h("span", { key: '337dc1b7c1f3a1edec24fe7e16caa6151db5f866', class: "additional-info-title" }, this.trigger), index.h("va-icon", { key: 'fce25a84051219134fb592b6c9577cfcb4709882', class: "additional-info-icon", icon: "chevron_right", size: 3 }))), index.h("div", { key: '92630d5719c2fcbffa7faf813c70894e7dffd76a', id: "info", class: infoClass }, index.h("slot", { key: 'a12bc2fa98fab92b4983e41b464d25ef40d33242' }))));
    }
    get el() { return index.getElement(this); }
};
VaAdditionalInfo.style = VaAdditionalInfoStyle0;

exports.va_additional_info = VaAdditionalInfo;
