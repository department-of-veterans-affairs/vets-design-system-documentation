...
const VaSegmentedProgressBar = class {
    constructor(hostRef) {
    ...
    render() {
        ...
        const indicatorClass = index$1.classnames({
        ...
        return (index.h(index.Host, null, index.h("div", { class: indicatorClass }, index.h("ol", { class: "usa-step-indicator__segments", "aria-hidden": labels ? null : 'true' }, range.map(step => (index.h("li", { class: computeSegmentClass(step), "aria-current": current === step + 1 ? 'step' : null }, labels ? (index.h("span", { class: "usa-step-indicator__segment-label" }, labelsArray[step], current !== step + 1 ? (index.h("span", { class: "usa-sr-only" }, current > step + 1 ? 'completed' : 'not completed')) : null)) : null)))), index.h("div", { class: "usa-step-indicator__header" }, index.h(Tag, { class: "usa-step-indicator__heading" }, index.h("span", { class: "usa-step-indicator__heading-counter" }, index.h("span", { class: "usa-sr-only" }, progressTerm), index.h("span", { class: "usa-step-indicator__current-step" }, current), index.h("span", { class: "usa-step-indicator__total-steps" }, " of ", total)), index.h("span", { class: "usa-step-indicator__heading-text" }, labels ? labelsArray[current - 1] : headingText))))));
    }
};
VaSegmentedProgressBar.style = VaSegmentedProgressBarStyle0;

exports.va_segmented_progress_bar = VaSegmentedProgressBar;
