...
const VaStatementOfTruth = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.vaInputChange = index.createEvent(this, "vaInputChange", 7);
        this.vaInputBlur = index.createEvent(this, "vaInputBlur", 7);
        this.vaCheckboxChange = index.createEvent(this, "vaCheckboxChange", 7);
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '4463c2700c0100fc5b487e8d50812a8997da61b8' }, index.h("p", { key: '97be20c903141887f855cfad67536c44292a7164', class: "font-sans-6" }, index.h("strong", { key: '82b385c6b0eb14ea8eac2794159c8e7aa4aa7a03' }, "Note:"), " According to federal law, there are criminal penalties, including a fine and/or imprisonment for up to 5 years, for withholding information or for providing incorrect information (Reference: 18 U.S.C. 1001)."), index.h("article", { key: '43757585701911f9f2a4bbd5609261f12d0b7fe9' }, index.h("h3", { key: '00b11161a5b33c3bcc758138fd6195ad41b36971' }, heading), index.h("slot", { key: '4179eb9802a93e062087da8a1ef4db55fc1a18e2' }), index.h("p", { key: '91ea0f1a7ce7eca92b0da96d848579a5220e0e98', class: "font-sans-6" }, "I have read and accept the\u00A0", index.h("va-link", { key: '6da7e9ffdae0487c98ff78014fd74c9eaf7b7a8c', external: true, text: 'privacy policy', href: '/privacy-policy/' }), "."), index.h("va-text-input", { key: '463663a9baf49df5024d88f385f8e5c184ec6159', id: "veteran-signature", name: "veteran-signature", label: inputLabel, value: inputValue, "message-aria-describedby": inputMessageAriaDescribedby, required: true, error: inputError, onInput: this.handleInputChange, onBlur: this.handleInputBlur }), index.h("va-checkbox", { key: '5f9dbb6b2373643ab1bb6d68295838764bff6a6e', id: "veteran-certify", name: "veteran-certify", label: checkboxLabel, required: true, checked: checked, error: checkboxError, onVaChange: this.handleCheckboxChange }))));
    }
    get el() { return index.getElement(this); }
};
VaStatementOfTruth.style = VaStatementOfTruthStyle0;

exports.va_statement_of_truth = VaStatementOfTruth;
