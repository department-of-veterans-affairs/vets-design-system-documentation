...
const VaProgressBar = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6d41c1a1d62ccb08a85a03fd4bca216319bdbfe2' }, index.h("div", { key: '60536ea0b71099558c33682cedd597d76b51dea8', "aria-label": label, "aria-valuemax": "100", "aria-valuemin": "0", "aria-valuenow": percent.toFixed(0), "aria-valuetext": label, class: "progress-bar", tabindex: "0", role: "progressbar" }, index.h("div", { key: '32cc03ebe2b6c7c6ec822d08647b61c951dde7d5', class: "progress-bar-inner", style: { width: `${percent}%` } })), index.h("span", { key: '1b322dd3d66173ed42c9d102686fcef02e7510dc', "aria-atomic": "true", "aria-live": "polite", class: "sr-only" }, percent.toFixed(0), "% complete")));
    }
};
VaProgressBar.style = VaProgressBarStyle0;

exports.va_progress_bar = VaProgressBar;
