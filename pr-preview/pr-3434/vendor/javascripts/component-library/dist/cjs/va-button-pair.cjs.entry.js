...
const VaButtonPair = class {
    constructor(hostRef) {
        ...
        this.primaryClick = index.createEvent(this, "primaryClick", 7);
        this.secondaryClick = index.createEvent(this, "secondaryClick", 7);
    ...
    render() {
        ...
        if (_continue) {
            return (index.h(index.Host, null, index.h("ul", { class: "usa-button-group" }, index.h("li", { class: "usa-button-group__item" }, index.h("va-button", { back: true, "disable-analytics": disableAnalytics, label: secondaryLabel, onClick: handleSecondaryClick })), index.h("li", { class: "usa-button-group__item" }, index.h("va-button", { continue: true, "disable-analytics": disableAnalytics, label: primaryLabel, onClick: handlePrimaryClick, submit: submit })))));
        }
        return (index.h(index.Host, null, index.h("ul", { class: "usa-button-group" }, index.h("li", { class: "usa-button-group__item" }, index.h("va-button", { "disable-analytics": disableAnalytics, label: primaryLabel, onClick: handlePrimaryClick, text: this.getLeftButtonText(), submit: submit })), index.h("li", { class: "usa-button-group__item" }, index.h("va-button", { "disable-analytics": disableAnalytics, label: secondaryLabel, onClick: handleSecondaryClick, secondary: true, text: this.getRightButtonText() })))));
    }
};
VaButtonPair.style = VaButtonPairStyle0;

exports.va_button_pair = VaButtonPair;
