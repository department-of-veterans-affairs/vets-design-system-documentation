...
const VaSearchInput = class {
    constructor(hostRef) {
        ...
        this.formatSuggestion = (suggestion) => {
            ...
            if (lowercaseSuggestion.includes(inputValue)) {
                return (index.h(index.Fragment, null, inputValue, index.h("strong", null, lowercaseSuggestion.replace(inputValue, ''))));
            }
            return index.h("strong", null, lowercaseSuggestion);
        };
        /**
    ...
    render() {
        ...
        const formClasses = index$1.classnames({
            'usa-search': true,
            'usa-search--big': big && !small,
            'usa-search--small': small && !big,
        });
        return (index.h(index.Host, { key: 'eb35f45653c403d132e8c84f6bc0350aa3625ffa', onBlur: handleBlur }, index.h("form", { key: '45cd65d86161f47a760f2d56093d9bbb0c004a32', class: formClasses, role: "search" }, index.h("label", { key: 'd8ebc006c6e8356a5cfe16fb7b7f9a13082c2a04', class: "usa-sr-only", htmlFor: "search-field" }, label), index.h("input", { key: '440da88c09c87df8dcde8b755eabdb0b0a3ef87a', class: "usa-input", id: "search-field", name: "search", type: "search", ref: el => (this.inputRef = el), "aria-autocomplete": ariaAutoComplete, "aria-controls": ariaControls, "aria-expanded": ariaExpanded, "aria-haspopup": ariaHasPopup, "aria-label": label, autocomplete: "off", onFocus: handleInputFocus, onInput: handleInput, onKeyDown: handleInputKeyDown, role: role, value: value }), index.h("button", { key: 'bd583abd6a472fdda92111945759888a25cd886e', class: "usa-button", type: "submit", onClick: handleButtonClick }, !small && (index.h("span", { key: 'd98711b4761a71aaef3b24d63293fbde1c216d23', class: "usa-search__submit-text" }, buttonText)), index.h("va-icon", { key: '9e4d5b26bc5bf8dca309126d3e246d911377d9b0', class: "usa-search__submit-icon", icon: "search", size: 3 })), isListboxOpen && (index.h("ul", { key: '1a0fd7ddd56fd3ee76fe18b863f92f545acc6a4e', id: "va-search-listbox", "aria-label": "Search Suggestions", role: "listbox" }, formattedSuggestions.map((suggestion, index$1) => {
            return (index.h("li", { id: `listbox-option-${index$1}`, class: "va-search-suggestion", onClick: () => handleListboxClick(index$1), onKeyDown: e => handleListboxKeyDown(e, index$1), role: "option", tabIndex: -1 }, suggestion));
        }))))));
    }
...
exports.va_search_input = VaSearchInput;
