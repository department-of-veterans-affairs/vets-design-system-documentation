...
const VaAccordionItem = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.accordionItemToggled = index.createEvent(this, "accordionItemToggled", 7);
        /**
    ...
    populateStateValues() {
        utils.getSlottedNodes(this.el, null).forEach((node) => {
    ...
    render() {
        ...
        const accordionItemClass = index$1.classnames({
        ...
        const Header = () => {
            ...
            const Tag = (headline && headline.tagName.includes("H"))
                ...
                // eslint-disable-next-line i18next/no-literal-string
                : `h${level}`;
            return (index.h(Tag, { class: "usa-accordion__heading" }, index.h("button", { type: "button", class: "usa-accordion__button", "aria-expanded": open ? 'true' : 'false', "aria-controls": "content", onClick: this.toggleOpen.bind(this), ref: el => {
                    this.expandButton = el;
                }, part: "accordion-header" }, index.h("span", { class: "va-accordion__header" }, index.h("slot", { name: "icon" }), this.slotHeader || header || ieSlotCheckHeader), this.subheader &&
                index.h("span", { class: "va-accordion__subheader" }, index.h("slot", { name: "subheader-icon" }), subheader))));
        };
        return (index.h(index.Host, null, index.h("div", { class: accordionItemClass }, index.h(Header, null), index.h("slot", { name: "headline", onSlotchange: () => this.populateStateValues() }), index.h("div", { id: "content", class: "usa-accordion__content usa-prose", hidden: !open, part: "accordion-content" }, index.h("slot", null)))));
    }
    get el() { return index.getElement(this); }
};
VaAccordionItem.style = VaAccordionItemStyle0;

exports.va_accordion_item = VaAccordionItem;
