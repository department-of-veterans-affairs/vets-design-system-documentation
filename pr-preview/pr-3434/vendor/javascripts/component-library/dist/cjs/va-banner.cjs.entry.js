...
const VaBanner = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("va-alert", { visible: true, "full-width": true, closeable: this.showClose, onCloseEvent: onCloseAlert, status: this.type, "data-role": "region", "data-label": bannerAriaLabel }, index.h("h3", { slot: "headline" }, this.headline), index.h("slot", null))));
    }
    get el() { return index.getElement(this); }
};
VaBanner.style = VaBannerStyle0;

exports.va_banner = VaBanner;
