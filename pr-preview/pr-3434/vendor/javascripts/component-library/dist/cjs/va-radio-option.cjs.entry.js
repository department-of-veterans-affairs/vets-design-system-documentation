...
const VaRadioOption = class {
    constructor(hostRef) {
        ...
        this.radioOptionSelected = index.createEvent(this, "radioOptionSelected", 7);
        this.name = undefined;
    ...
    render() {
        ...
        return (index.h("div", { key: '0c0b521e30a78cfe8b6b1ef9d5d55d5e0505240e', class: "usa-radio" }, index.h("input", { key: '6d16aba7ec1e33767f153629e4f2b789785a86bc', class: inputClass, type: "radio", name: name, value: value, checked: checked, disabled: disabled, onClick: () => this.handleChange(), id: id + 'input' }), index.h("label", { key: 'd2e5c838dbf84e23b86a56b9a6ddabe9733b6055', class: "usa-radio__label", htmlFor: id + 'input', role: "radio", "aria-checked": ariaChecked }, label, description && (index.h("span", { key: '99ade2ffe8974118d69bdb49626446d1feb6f49a', class: "usa-radio__label-description dd-privacy-hidden", "data-dd-action-name": "description" }, description)))));
    }
    get el() { return index.getElement(this); }
};
VaRadioOption.style = VaRadioOptionStyle0;

exports.va_radio_option = VaRadioOption;
