...
const VaSelect = class {
    constructor(hostRef) {
        ...
        this.vaKeyDown = index.createEvent(this, "vaKeyDown", 7);
        this.vaSelect = index.createEvent(this, "vaSelect", 7);
    ...
    populateOptions() {
        ...
        const allNodes = utils.getSlottedNodes(this.el, null);
        ...
        this.options = nodes.map((node) => {
            if (node.nodeName.toLowerCase() === 'optgroup') {
                return (index.h("optgroup", { label: node.label }, Array.from(node.children).map((child) => {
                    return (index.h("option", { value: child.value, selected: value === child.value }, child.text));
                })));
            }
            else if (node.nodeName.toLowerCase() === 'option') {
                return (index.h("option", { value: node.value, selected: value === node.value }, node.textContent));
            }
        });
    }
    handleValueChange() {
    ...
    render() {
        ...
        const selectClass = index$1.classnames({
            'usa-select': true,
            'usa-input--error': error || reflectInputError,
            [`usa-input--${width}`]: width,
        });
        return (index.h(index.Host, { key: '39bab09123631e2478c690636b8f231f9e71be72' }, label && (index.h("label", { key: '57dc50adce29902a24c39c05e9d7db6e4a9c3bf3', htmlFor: "options", class: labelClass, part: "label" }, label, required && (index.h("span", { key: '7e0a65b91465459de3adef89dc83f6fdfb16d86b', class: "usa-label--required" }, " ", i18next.instance.t('required'))))), hint && (index.h("span", { key: 'ee8cf774f53afc15b51bb42e50c27928f13cbd94', class: "usa-hint", id: "input-hint" }, hint)), index.h("span", { key: '30ecf636ffebf2e9625f9691b4a92f20868a067c', id: errorID, role: "alert" }, showError && error && (index.h(index.Fragment, { key: '83f7d0c56bd4f672b16566d824b954eb237db616' }, index.h("span", { key: '4b06d590aa38bb2dff18c5c0b7dc9a0bcb79802e', class: "usa-sr-only" }, i18next.instance.t('error')), index.h("span", { key: '2bbe45696d4f1092e81800bc6cd0cb7ac2f9e5d9', class: "usa-error-message" }, error)))), index.h("slot", { key: '2480eceb19344e0663c82d1949a1185b8b506663', onSlotchange: () => this.populateOptions() }), index.h("select", { key: 'cc0220bd96db8d223501d43576030f434eb3fd54', class: selectClass, "aria-describedby": ariaDescribedbyIds, "aria-invalid": invalid || error ? 'true' : 'false', id: "options", name: name, required: required || null, onKeyDown: () => this.handleKeyDown(), onChange: e => this.handleChange(e), part: "select" }, index.h("option", { key: "0", value: "", selected: true }, i18next.instance.t('select')), this.options), messageAriaDescribedby && (index.h("span", { key: '76e168f3286173803213e22c002d7584da4d3a3c', id: "input-message", class: "usa-sr-only dd-privacy-hidden" }, messageAriaDescribedby))));
    }
...
const VaTextInput = class {
    constructor(hostRef) {
        ...
        this.handleBlur = (e) => {
            ...
            if (this.inputmode === 'decimal' || this.inputmode === 'numeric' || this.currency) {
                let defaultError = i18next.instance.t('number-error');
                const target = e.target;
    ...
    render() {
        ...
        const currencyWrapper = index$1.classnames({
        ...
        const errorClass = index$1.classnames({
        ...
        return (index.h(index.Host, null, formsHeading, index.h("div", { class: "input-wrap" }, label && (index.h("label", { htmlFor: "inputField", id: "input-label", class: labelClass, part: "label" }, label, required && (index.h("span", { class: "usa-label--required" }, ' ', i18next.instance.t('required'))), hint && index.h("span", { class: "usa-hint" }, hint))), index.h("slot", null), index.h("span", { id: "input-error-message", role: "alert", class: errorClass }, error && (index.h(index.Fragment, null, index.h("span", { class: "usa-sr-only" }, i18next.instance.t('error')), index.h("span", { class: "usa-error-message" }, error)))), index.h("div", { class: currencyWrapper }, currency && index.h("div", { id: "symbol" }, "$"), inputPrefix && index.h("div", { class: "usa-input-prefix", part: "input-prefix" }, inputPrefix.substring(0, 25)), inputIconPrefix && index.h("div", { class: "usa-input-prefix", part: "input-prefix" }, index.h("va-icon", { icon: inputIconPrefix, size: 3, part: "icon" })), index.h("input", { class: inputClass, id: "inputField", type: type, value: value, onInput: handleInput, onBlur: handleBlur, "aria-describedby": ariaDescribedbyIds, style: style, "aria-labelledby": ariaLabeledByIds, "aria-invalid": invalid || error || charCountTooHigh ? 'true' : 'false', inputmode: inputmode, step: step, maxlength: maxlength, pattern: pattern, name: name, autocomplete: autocomplete, required: required || null, part: "input", min: min, max: max }), inputSuffix && index.h("div", { class: "usa-input-suffix", part: "suffix", "aria-hidden": "true" }, inputSuffix.substring(0, 25)), inputIconSuffix && index.h("div", { class: "usa-input-suffix", part: "input-suffix" }, index.h("va-icon", { icon: inputIconSuffix, size: 3, part: "icon" }))), messageAriaDescribedby && (index.h("span", { id: "input-message", class: "usa-sr-only dd-privacy-hidden" }, messageAriaDescribedby)), charcount && maxlength && (index.h("span", { id: "charcount-message", class: messageClass, "aria-live": "polite" }, utils.getCharacterMessage(value, maxlength))))));
    }
    get el() { return index.getElement(this); }
};
VaTextInput.style = VaTextInputStyle0;

exports.va_select = VaSelect;
exports.va_text_input = VaTextInput;
