...
const VaModal = class {
    ...
    render() {
        ...
        const btnAriaLabel = modalTitle
            ...
            : 'Close modal';
        const wrapperClass = index$1.classnames({
            'usa-modal': true,
            'va-modal-alert': status,
            'usa-modal--lg': this.large,
        });
        const contentClass = index$1.classnames({
            'usa-modal__content': true,
            'usa-modal-alert': status,
        });
        const bodyClass = index$1.classnames({
            'usa-modal__main': true,
            'usa-modal-alert': status,
            'va-modal-alert-body': status,
        });
        const titleClass = index$1.classnames({
            'usa-modal__heading': true,
            'va-modal-alert-title': status,
        });
        const closingButton = forcedModal ? ('') : (index.h("button", { "aria-label": btnAriaLabel, class: "va-modal-close", onClick: e => this.handleClose(e), ref: el => (this.closeButton = el), type: "button" }, index.h("va-icon", { icon: "cancel", size: 4 })));
        /* eslint-disable i18next/no-literal-string */
        ...
        return (index.h(index.Host, null, index.h("div", { class: wrapperClass, role: status === 'warning' || status === 'error'
                ? 'alertdialog'
                : 'dialog', "aria-label": ariaLabel, "aria-modal": "true" }, index.h("div", { class: contentClass }, closingButton, status && (index.h("va-icon", { class: "va-modal-alert__icon", icon: statusIcon, size: 4 })), index.h("div", { class: bodyClass }, index.h("div", { role: "document" }, modalTitle && (index.h("h2", { class: titleClass, tabindex: -1, id: "heading" }, modalTitle)), index.h("div", { class: "usa-prose", id: "description" }, index.h("slot", null))), ((primaryButtonClick && primaryButtonText) ||
            (secondaryButtonClick && secondaryButtonText)) && (index.h("div", { class: "usa-modal__footer", ref: el => (this.alertActions = el) }, index.h("ul", { class: "usa-button-group" }, primaryButtonClick && primaryButtonText && (index.h("li", { class: "usa-button-group__item" }, index.h("va-button", { onClick: e => this.handlePrimaryButtonClick(e), text: primaryButtonText }))), secondaryButtonClick && secondaryButtonText && (index.h("li", { class: "usa-button-group__item" }, !unstyled && (index.h("va-button", { onClick: e => this.handleSecondaryButtonClick(e), secondary: true, text: secondaryButtonText })), unstyled && (index.h("button", { onClick: e => this.handlePrimaryButtonClick(e), type: "button", class: "usa-button usa-button--unstyled" }, secondaryButtonText))))))))))));
    }
...
const VaTelephone = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c4850a9fc90f007fc8712331913edd0d102dcf91' }, notClickable ? (index.h(index.Fragment, null, index.h("span", { "aria-hidden": "true", "aria-describedby": ariaDescribedbyIds }, formattedNumber))) : (index.h("a", { "aria-describedby": ariaDescribedbyIds, href: VaTelephone.createHref(contact, extension, sms), onClick: this.handleClick.bind(this) }, formattedNumber)), messageAriaDescribedby && (index.h("span", { key: '6736d7ff067a3e2b0f050c0ffa75c11c36b60217', id: "number-description", class: "sr-only" }, messageAriaDescribedby))));
    }
};
VaTelephone.style = VaTelephoneStyle0;

exports.va_modal = VaModal;
exports.va_telephone = VaTelephone;
