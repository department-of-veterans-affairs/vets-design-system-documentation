...
const VaPrivacyAgreement = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ae62338a2e8475f12f3407524702c7d561f06081' }, index.h("va-checkbox", { key: 'dd121aef9f7d461f338ecfd155e17582c3eb97ed', required: true, error: this.errorMessage(), id: "checkbox", label: "I have read and accept the privacy policy.", checked: this.checked, onVaChange: this.handleCheckboxChange }, index.h("span", { key: 'd531e4af848d7fbf8edc09ccd5d9815300344303', class: `${labelClass} description`, slot: "description" }, "Please read and accept the\u00A0", index.h("a", { key: '96f8241aec3f6592fe0c8f56fcb9dbc7ae04e55b', href: "/privacy-policy/", target: "_blank" }, "privacy policy", index.h("va-icon", { key: 'e684d794200629d5e5eafbc2d6fc3f571dd968db', class: "privacy-policy-icon", icon: "launch", size: 2 }), index.h("span", { key: '0f4a636d0c36575300b39780e5bd53def0f7be3e', class: "usa-sr-only" }, "opens in a new window")), "."))));
    }
};
VaPrivacyAgreement.style = VaPrivacyAgreementStyle0;

exports.va_privacy_agreement = VaPrivacyAgreement;
