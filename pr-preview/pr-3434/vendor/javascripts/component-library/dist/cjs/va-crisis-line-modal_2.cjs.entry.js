...
const contacts = require('./contacts-f7ea2d3e.js');
...
const VACrisisLineModal = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4e90c5d4db78e8d37d4e72bd00d723ffc207fd5c' }, index.h("div", { key: 'bc05ef2144c56cbf0d60a7f7da955ba36209654d', class: "va-crisis-line-container" }, index.h("button", { key: 'a7f4581ecfb67abd60ebc58153908bd1ceb4430f', onClick: () => this.setVisible(), onFocusin: () => this.trapFocus(), "data-show": "#modal-crisisline", class: "va-crisis-line va-overlay-trigger", part: "button" }, index.h("div", { key: '1c34f4579d7db003d731b0b9e69f0f58bc642caf', class: "va-crisis-line-inner" }, index.h("span", { key: 'dd11b1684c385712e0df2ee09861fecd92bdf93d', class: "va-crisis-line-icon", "aria-hidden": "true" }), index.h("span", { key: '8dfebbee9eb46675094e07963a68d85d1472afe1', class: "va-crisis-line-text" }, "Talk to the ", index.h("strong", { key: 'de53465ae24dfea04d8cccd9ad881a15bf0b590b' }, "Veterans Crisis Line"), " now"), index.h("va-icon", { key: 'dd02180de69097e0c09bbd74891cc87bf6566ea3', class: "va-icon__right-arrow", icon: "navigate_next", size: 3 })))), index.h("va-modal", { key: 'a0ab2dcc7e9db96f1874e74b8924aefde1ed9b90', modalTitle: "We\u2019re here anytime, day or night \u2013 24/7", onPrimaryButtonClick: () => this.setNotVisible(), onCloseEvent: () => this.setNotVisible(), visible: this.isOpen, large: true }, index.h("p", { key: 'a8cc0770ab7cb8cd2791f5a25f578251012cbe49' }, "If you are a Veteran in crisis or concerned about one, connect with our caring, qualified responders for confidential help. Many of them are Veterans themselves."), index.h("ul", { key: 'dfea79a845e3959b397f820b6fac4a7312a07261', class: "va-crisis-panel-list" }, index.h("li", { key: 'c7e18da47b5bb5bca1edb9000c3de4769fdb9cfd' }, index.h("va-icon", { key: '691a03eb6546edfa64c961d04ab184400844616a', class: "va-clm__icon", icon: "phone", size: 3 }), index.h("span", { key: '9d184d69e2c256469858a428da0ccfab6504b0a0' }, "Call", ' ', index.h("strong", { key: '59999060bbfd8b2eed02710e3c9519d15cc0ffc7' }, index.h("va-telephone", { key: '05ce0783810af34eb1641bea00b68fed4d0ba143', contact: "988" }), " and select 1"))), index.h("li", { key: '5f8cbde7e495ce7d0a0503fe4d59dc6136907d92' }, index.h("va-icon", { key: '55a91221adf00df947fdc0a712a4d40bd7623302', icon: "phone_iphone", class: "va-clm__icon", size: 3 }), index.h("span", { key: '80bb0f592dc03bdcac6992ced2b9b270eb3c329a' }, "Text\u00A0", index.h("strong", { key: 'c42270b926bb76f289265631800dda850654ea4e' }, index.h("va-telephone", { key: '5d746961661530563939267adcdd8d185dc5e5c7', sms: true, contact: "838255" })))), index.h("li", { key: '75e9e7b146d90901f36e34e21fda6c49ee5a9c85' }, index.h("va-icon", { key: 'd8fcdf74c85119f7623a12f0ca3c4d7b4a429438', icon: "chat", class: "va-clm__icon", size: 3 }), index.h("a", { key: '76fcf1c4b288aea711068a7d325fe8b976ab3539', class: "no-external-icon", href: "https://www.veteranscrisisline.net/get-help-now/chat/" }, "Start a confidential chat")), index.h("li", { key: 'f359a96b1f39f9bf5e9082b6563be99b6f5d608b' }, index.h("va-icon", { key: 'b76ffa21861676d1d515df138f18e0689cda4e1b', icon: "tty", class: "va-clm__icon", size: 3 }), index.h("p", { key: '9ad60032abc74eab181cbc1aea3fb70906286b7d' }, "Call TTY if you have hearing loss", ' ', index.h("strong", { key: '7f4d6d6b4a68ff6fe773f302fceceb0b6f20e83f' }, index.h("va-telephone", { key: '4466d858b720245c9e7726240b3e70ee29c2acfa', tty: true, contact: contacts.CONTACTS.CRISIS_TTY }))))), index.h("p", { key: '63d09c7339f8858c969e9d6ced03a06aa7c01237' }, "Get more resources at", ' ', index.h("a", { key: '34483ed00ac1ce1365f685bd4cf2816314fa0ddc', class: "no-external-icon", href: "https://www.veteranscrisisline.net/" }, "VeteransCrisisLine.net")))));
    }
...
const VaOfficialGovBanner = class {
    constructor(hostRef) {
        ...
        this.govSiteExplanationText = () => {
            ...
            if (el) {
                const text = i18next.instance.t('gov-site-explanation', { tld: this.tld });
                if (text) {
    ...
    <path fill="#000000" fill-rule="evenodd" d="M26 0c10.493 0 19 8.507 19 19v9h3a4 4 0 0 1 4 4v28a4 4 0 0 1-4 4H4a4 4 0 0 1-4-4V32a4 4 0 0 1 4-4h3v-9C7 8.507 15.507 0 26 0zm0 8c-5.979 0-10.843 4.77-10.996 10.712L15 19v9h22v-9c0-6.075-4.925-11-11-11z"></path>
            ...
            let html = i18next.instance.t('gov-site-lock', { image: 'SVG', tld: this.tld });
    ...
    render() {
        const { tld } = this;
        if (tld === 'gov' || tld === 'mil') {
            return (index.h(index.Host, { key: '7869b4f29a61109e708b0b812f2f211c77ebe207' }, index.h("div", { key: '1917bf586f23db18d8f8d478a9527fcff2205eba', class: "banner" }, index.h("div", { key: '25f9b3966635fe3b1d2da5fe70a71fd11a307c20', class: "accordion" }, index.h("div", { key: '356b803c72b3cf83e8450a2dcd5a94e44a6f1e58', id: "header" }, index.h("div", { key: '49111939f4236ee2a15ef1ab64215833912519ed', class: "inner" }, index.h("div", { key: '3bb1a2198a638a540204f82f12d030b732023741', class: "grid-col-auto" }, index.h("img", { key: 'b66cea16919e69bbb2c3d03f400d32326b4c8d35', role: "presentation", class: "header-flag", src: "https://s3-us-gov-west-1.amazonaws.com/content.www.va.gov/img/tiny-usa-flag.png", alt: "" })), index.h("div", { key: '302252b34a8ba9d10ad2da69e02e3ec40960c6b1', class: "grid-col-fill", "aria-hidden": "true" }, index.h("p", { key: 'eee51d08d14cd5975b4d729582779be8d07dc8aa', class: "header-text" }, i18next.instance.t('gov-site-label')), index.h("p", { key: '417c200daf3e4d587e480e5d711b13082fcb83fe', class: "header-action" }, i18next.instance.t('gov-site-button'))), index.h("button", { key: '74592195c2409306705ad662985ade6092a91cbe', onClick: this.handleClick, type: "button", "aria-expanded": "false", "aria-controls": "official-gov-banner" }, index.h("span", { key: '80f36bb8be8553548abdeb381563e87b18e5e112', class: "button-text" }, i18next.instance.t('gov-site-button'))))), index.h("div", { key: 'a030f5f60ff2df42dd3b1b1d3f2c166e16e926f5', class: "content", id: "official-gov-banner", hidden: true }, index.h("div", { key: 'd1d5fc20349f14c8f0d016db2b1c247e8299ab20', class: "grid-row" }, index.h("div", { key: '7fc85f0756a6300403c71949ecf1a30548fce1ca', class: "col" }, index.h("img", { key: 'cd2f510b514a7e84258e555a5e459fdf48473263', src: iconHttpsSvg, role: "presentation", alt: "" }), index.h("div", { key: '3f2f7b9a2ab9c70d9a80cc0d1be645f1980990a1', class: "media-block" }, index.h("p", { key: '6f6852b6484352e74ef942736616389be028dfbf' }, index.h("strong", { key: 'e2b1d94e183ee1cf46c60e361cb12567cc64041d' }, i18next.instance.t('gov-site-website', { tld })), index.h("br", { key: '618e591cad753873414998ceb66d3f4e693f316e' }), index.h("span", { key: '9912992f63c631e199cee6154b5fcfe9d37b993d', class: "gov-site-explanation-text" }, this.govSiteExplanationText())))), index.h("div", { key: 'f8ad1d503009409195f21d1c1d9fde04d6fc54e4', class: "col" }, index.h("img", { key: 'f0d4c7dfae9033416d9efc656dd6ef91c000eeeb', src: iconDotGovSvg, role: "presentation", alt: "" }), index.h("div", { key: 'd543254a725a00b887f1bd3b61a2ae00373d5e99', class: "media-block" }, index.h("p", { key: '96a91d463ce139ab688cb955186e9ca6679af047' }, index.h("strong", { key: '39878bbcaaab8a6cba50cdd6e8dd724d9a3dbafa' }, i18next.instance.t('gov-site-https', { tld })), index.h("br", { key: '3a4861f344650125aacddd082d2a55aa658204ff' }), index.h("span", { key: '019edac97e6ce44ae7a6a464911b4590019a372b', class: "gov-site-lock-text" }, this.govSiteLockText()))))))))));
        }
    }
    get el() { return index.getElement(this); }
};
...
exports.va_crisis_line_modal = VACrisisLineModal;
exports.va_official_gov_banner = VaOfficialGovBanner;
