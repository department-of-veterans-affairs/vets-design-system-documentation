...
const VaAlertExpandable = class {
    ...
    render() {
        ...
        const alertClasses = index$1.classnames('alert-expandable', status, {
            'hide-icon': iconless,
        });
        const bodyClasses = index$1.classnames('alert-expandable-body', {
            open: open,
            closed: !open,
        });
        /* eslint-disable i18next/no-literal-string */
        ...
        /* eslint-enable i18next/no-literal-string */
        return (index.h(index.Host, { key: 'f9b7a808ae0ff40b6247e83761d8485a0883fab7' }, index.h("div", { key: '15d1634b3dfd254ff5adc38a64d65e9c230eb591', role: role, "aria-live": ariaLive, class: alertClasses }, index.h("a", { key: 'aa0ca0fdad85ec30aadbc8275cd9ab2c99594bcc', role: "button", "aria-controls": "alert-body", "aria-expanded": this.open ? 'true' : 'false', tabIndex: 0, onClick: this.toggleOpen.bind(this), onKeyDown: this.handleKeydown.bind(this), class: "alert-expandable-trigger" }, !iconless && (index.h("va-icon", { key: '9b64838fc6606b15dab89efdc4904d2904a1bec1', class: "alert-expandable__status-icon", icon: statusIcons[status] || 'info', size: 3 })), index.h("div", { key: 'b0284e2207a6ae6643f67700549ee1834a5b0a61' }, index.h("span", { key: '13db1b1cf56f0716587d5266d3d7e20f012b3757', class: "alert-expandable-title" }, index.h("span", { key: '74fec1def64c9285972dd78c92debc43fc74a7bc', class: "sr-only" }, "Alert:\u00A0"), this.trigger), index.h("va-icon", { key: '9def91d4212df0695cae1fbf63ec69796bcbb69e', class: "alert-expandable-icon", icon: "chevron_right", size: 3 }))), index.h("div", { key: 'a26104885d223294c4ee0cae04ce499c47b095fa', id: "alert-body", class: bodyClasses }, index.h("div", { key: '64f540bad4d4e511880a5a56a1334b1c6d4e0bc3', id: "slot-wrap" }, index.h("slot", { key: 'ba32ab7b9eaf6dfdf5596560102515f4cd513cbd' }))))));
    }
    get el() { return index.getElement(this); }
};
VaAlertExpandable.style = VaAlertExpandableStyle0;

exports.va_alert_expandable = VaAlertExpandable;
