...
const VaRadio = class {
    constructor(hostRef) {
        ...
        this.vaValueChange = index.createEvent(this, "vaValueChange", 7);
    ...
    handleKeyDown(event) {
        ...
        const radioOptionNodes = utils.getSlottedNodes(this.el, 'va-radio-option')
    ...
    radioOptionSelectedHandler(event) {
        ...
        utils.getSlottedNodes(this.el, 'va-radio-option')
    ...
    render() {
        ...
        if (isFormsPattern) {
            ...
            formsHeading = (index.h(index.Fragment, { key: '698798e7e27e1b747b679f16fcfba5a400a83950' }, formHeading &&
                index.h(HeaderLevel, { key: '798d4af26e9080928c66dd174a616d198d69bf15', id: "form-question", part: "form-header" }, formHeading), index.h("div", { key: '9fe73acc02a3310c8bd295cf62a3328aa668d423', id: "form-description" }, index.h("slot", { key: 'c8dd2491d58438402334525fc2c440cf6187cc3a', name: "form-description" }))));
        }
        return (index.h(index.Host, { key: 'c6d178dd0247932956ed1eb9ce1a5246b423e4c5', "aria-invalid": error ? 'true' : 'false' }, formsHeading, index.h("div", { key: 'edd064c2a352b975024b6edce2e04c320ef7c7e1', class: "input-wrap" }, index.h("fieldset", { key: 'bd7f91d3775d22a6a33b182a03417d4922f560f9', class: "usa-fieldset", "aria-labelledby": ariaLabeledByIds }, index.h("legend", { key: '606eb9d1ae32932214c1d293a1b75a8c568bc4f1', class: legendClass, part: "legend", "aria-describedby": messageAriaDescribedbyId }, HeaderLevel ? (index.h(HeaderLevel, { part: "header", "aria-describedby": headerAriaDescribedbyId }, label)) : (label), "\u00A0", useFormsPattern === 'multiple' && (index.h("span", { key: 'b056c76f2471d43fefad514c0888d48a1fc85ccd', id: "header-message", class: "usa-sr-only" }, label)), headerAriaDescribedby && (index.h("span", { key: 'e630f85e3cc1fbfbeedac77c8586b0dcfe26a7c0', id: "header-message", class: "usa-sr-only" }, headerAriaDescribedby)), messageAriaDescribedby && (index.h("span", { key: '2ffc818d35b2b59bf8692d969f6f8af33a3c0d05', id: "description-message", class: "usa-sr-only" }, messageAriaDescribedby)), required && index.h("span", { key: '262104151ca1cbfbaae93e7cb8e9f91547a60ac3', class: "usa-label--required", part: "required" }, i18next.instance.t('required')), hint && index.h("div", { key: '9eaf0a5d63ea07e7f4ae1eee6cc6ac4db6c0e5bb', class: "usa-hint" }, hint)), index.h("span", { key: '13f67f2c319080ac4c8f021e8818401b4d0df98c', class: "usa-error-message", role: "alert" }, error && (index.h(index.Fragment, { key: '49d3d2fe968b9d9ab766a273cd46ba8409408cc1' }, index.h("span", { key: 'd1cc1252467866665b840eb253368b89dbd03f0b', class: "usa-sr-only" }, i18next.instance.t('error')), " ", error))), index.h("slot", { key: '2362384a0de7f2b2ea66c1766e693bb261128f0b' })))));
    }
    get el() { return index.getElement(this); }
};
VaRadio.style = VaRadioStyle0;

exports.va_radio = VaRadio;
