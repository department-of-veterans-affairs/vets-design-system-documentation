...
In short, a component or pattern may not move backwards through the scale in a linear fashion. In fact, a component or pattern may be deprecated from any other status, if necessary. When we decide to deprecate a pattern, the Design System Team has [a process it follows to do so]({{ site.baseurl }}/about/contributing-to-the-design-system/suggest-a-removal#how-the-design-system-team-deprecates-a-component).