...
| ---------------------------------------- | ----- | ----------- | --------- | ------ | -------- |
| SITEWIDE Advance notification of scheduled downtime | **We'll be doing site maintenance on [Month, Date] between [00:00 a.m or p.m.] and [00:00 a.m or p.m.] ET.**  | You won’t be able to sign in or use some tools during this time. | [Promo banner](/components/promo-banners) | [Announcement](/components//promo-banners#benefit-announcements) | N/A |
| SITEWIDE Countdown notication of scheduled downtime | **We’ll be starting site maintenance in [X] minutes** | If you’re filling out a form or using tools, sign in or create an account to save your work. | [Promo banner](/components/promo-banners) | [Announcement](/components//promo-banners#benefit-announcements) | N/A |
| SITEWIDE Notice during scheduled downtime | **We’re working on VA.gov right now** | If you have trouble signing in or using some tools, check back after [Month, Date at 00:00 a.m. or p.m. ET]. | [Promo banner](/components/promo-banners) | [Announcement](/components//promo-banners#benefit-announcements) | N/A |
| IN-APP Notice of upcoming scheduled downtime | **[APPLICATION NAME] will be unavailable soon** | We'll be doing some work on [APPLICATION NAME] on [Month, Date] between [00:00 a.m. or p.m.] and [00:00 a.m. or p.m ET]. If you have trouble using this tool during that time, please check back soon. | [React component](https://department-of-veterans-affairs.github.io/veteran-facing-services-tools/visual-design/components/alertbox/) | [Warning](/components/alertboxes#informational-alert) | N/A |
|IN-APP Notice during scheduled downtime | **This form is unavailable right now** | We’re making some updates to our site. We hope to be finished by [Month, Date] at [00:00 a.m or p.m. ET]. Please check back soon. | [React component](/components/modal) | [Warning](https://department-of-veterans-affairs.github.io/veteran-facing-services-tools/visual-design/components/alertbox/) | N/A |
...
| SIGN-IN Notification of unscheduled downtime | **You may have trouble signing in or using some tools or services** | We’re doing some work on VA.gov right now. We hope to finish our work by [Month, Date] at [00:00 a.m. or p.m. ET]. If you have trouble using any tools or services, please check back after then. | [Alert box](/components/alertboxes) | [Warning alert](/components/alertboxes#warning-alert) | N/A |
