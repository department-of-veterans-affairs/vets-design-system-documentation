...
Cards group short, related pieces of information into discrete containers, similar to physical index or playing cards. In most cases, the goal of a card is to present a summary of information in one digestable chunk with the option to navigate to more details. The context of use for cards can vary widely, but at a minimum all cards share these elements:
