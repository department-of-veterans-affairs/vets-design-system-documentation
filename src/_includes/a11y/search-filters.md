...
* **For filtering, move focus to the results heading or results description.** This orients users and helps them find updated content quickly.
* **For sorting, maintain focus on the component.** Users may not expect implicit submission, so moving focus to the results heading or results description could be disorienting. 
