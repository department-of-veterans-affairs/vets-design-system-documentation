...
* **After applying Filter, move focus to the results heading or results description.** This orients users and helps them find updated content quickly.
* **After applying Sort, maintain focus on the component.** Users may not expect implicit submission, so moving focus to the results heading or results description could be disorienting. 
