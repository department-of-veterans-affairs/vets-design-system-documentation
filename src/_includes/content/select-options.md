...
* **Binary options that need a large tap target.** When you have Yes/No questions that require a larger tap target. See [Buttons as radio button]({{ site.baseurl }}/components/button/#secondary-button-as-radio-button) guidance for specifics.
