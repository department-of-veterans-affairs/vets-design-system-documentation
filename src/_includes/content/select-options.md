...
* **When the task is to sort a set of results.** For this situation, use the dedicated [Sort]({{  site.baseurl }}/components/sort)component, which utilizes a Select component as it's foundation.
