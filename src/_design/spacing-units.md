...
Formation’s spacing units are based on multiples of 8 to maintain a consistent rhythm when applied margins, padding, and other dimensions.
</div>
...
In order to access the spacing tokens in your project, you will need to import Formation’s [base files](https://github.com/department-of-veterans-affairs/design-system/tree/master/packages/formation/sass/base) into your project files.
