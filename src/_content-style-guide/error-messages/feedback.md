...
intro-text: Feedback messages appear as a response to a person’s actions. Most of create, read, update, and delete actions will result in feedback messaging.
---
...
<va-table>
    ...
    <va-table-row>
        <span>Save in progress success (inline)</span>
    ...
    <va-table-row>
        <span>Save in progress success (exit page)</span>
    ...
    <va-table-row>
        <span>Save in progress success (inline)</span>
        <span><b>We’re saving your [name of what's saved (e.g., new mobile phone number)]</b></span>
        ...
        <span>After affected component</span>
    <va-table-row>
        <span>Save in progress failure (inline)</span>
    ...
    <va-table-row>
        ...
        <span>We’re sorry. There’s a problem with [name]. Refresh this page or try again later.
    ...
    <va-table-row>
        ...
        <span>We’re sorry. There’s a problem with our system. Check back later.
    ...
    <va-table-row>
        <span>Submission failure, can save in progress</span>
    ...
    <va-table-row>
        <span>Submission failure, can't save in progress</span>
    ...
    <va-table-row>
        ...
        <span>Your submission is in progress.
    ...
    <va-table-row>
        <span>Submission in progress, alternate version</span>
        <span><b>Your [application, claim, form] is in progress and was last saved on [Month Day, Year], at [timestamp]</b></span>
        <span>You can continue applying now or come back later to finish your application.
        Your application will expire on [Month Day, Year], at [timestamp].</span>
    ...
    <va-table-row>
        ...
        <span>Try again later.</span>
        <span>Dismissible</span>
        <span><a href="{{ site.baseurl }}/components/alert#error-alert">Alert box</a></span>
        <span>Error</span>
        <span>Before page title</span>
    </va-table-row>
    <va-table-row>
