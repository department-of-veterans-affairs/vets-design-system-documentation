...
{% include component-example.html alt="An example of the process list component on a VEAP benefits page." file="/images/components/process-list/VEAP-benefits-2024.png" caption="The Education benefits application form 1995 uses a process list on the introduction page of the application." width="50%" %}
