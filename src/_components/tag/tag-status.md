...
* **Use sentence case.** While [Tag]({{ site.baseurl }}/components/tag/) without status are capitialized, these Tags use sentence case to improve readibility if the status is longer than 1-2 words. 
