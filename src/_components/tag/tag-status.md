...
* **Use sentence case.** While [Tags]({{ site.baseurl }}/components/tag/) without status are capitialized, these Tags use sentence case to improve readibility incase the status is longer than 1-2 words. 
