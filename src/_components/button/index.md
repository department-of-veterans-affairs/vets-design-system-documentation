...
* **Avoid using chevrons in buttons.** Chevrons are generally reserved for links. The only exception is for components that use the chevron to indicate the direction in which additional content opens, like in drawers, flyout menus, and dropdowns.
